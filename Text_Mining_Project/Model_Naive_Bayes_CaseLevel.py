...
feature_df_gnb = pd.read_csv("/home/ahlem/Text_Mining_Project/preprocessed_data_caseLevel.csv", encoding = "ISO-8859-1").astype(int)

#getting the raw data for plotting the classes according to case_name
# raw_case_data=pd1.read_csv(r'C:\Users\Admin\Documents\TMP\data.csv',encoding = "ISO-8859-1")
...
for term in term_range:
    ...
    target_data_train_Y = feature_df_gnb.loc[train_index_gnb, "case_level_decision"]
    ...
    feature_data_test_X = feature_df_gnb.loc[test_index_gnb , ['term', 'natural_court', 'argument_month', 'decision_month',
               ...
               'issue', 'issueArea', 'lawType', 'lawSupp', 'petitionerState', 'respondentState',
               'partyWinning', 'majVotes']]
    target_data_test_Y = feature_df_gnb.loc[test_index_gnb, "case_level_decision"]
...
target_actual_gnb = feature_df_gnb.loc[evaluation_index_gnb, "case_level_decision"]
...
#plot the values of the classes given the term for case centric
